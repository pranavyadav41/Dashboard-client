...
const EmployeeList = () => {
  ...
  const EmptyState = () => (
    <div className="flex flex-col items-center justify-center h-64 bg-white rounded-lg shadow-md">
      <p className="text-xl font-semibold text-gray-600 mb-4">No employee data found</p>
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <header className="bg-white shadow-md p-4 sticky top-0 z-10">
        <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={addEmployee}
              className="inline-flex gap-2 md:gap-0 items-center px-3 py-3 md:px-6 md:py-3 border border-transparent text-[#5d6373] text-sm md:text-base font-medium rounded-md text-indigo-700 bg-[#e5e6eb] hover:bg-gray-100 transition duration-300"
            >
      ...
      <div className="container mx-auto p-4 flex flex-col sm:flex-row gap-4">
        ...
        <div className={`sm:w-64 bg-white p-4 rounded-lg shadow-md ${isFilterOpen ? 'block' : 'hidden'} sm:block`}>
          ...
          <div className="mb-4">
            ...
            {departments.map(department => (
              <div key={department} className="flex items-center mb-2">
                ...
                />
                <label htmlFor={`department-${department}`} className="ml-2 text-sm">
                  {department}
                </label>
              </div>
            ))}
              ...
              <div className="hidden sm:block">
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  <div className="grid grid-cols-4 gap-4 p-4 font-semibold text-gray-700 border-b">
                    ...
                    <div className="cursor-pointer flex items-center" onClick={() => handleSort('department')}>
                      Department <SortIcon columnKey="department" />
                    </div>
                    <div className="cursor-pointer flex items-center" onClick={() => handleSort('role')}>
                  ...
                  {filteredEmployees.map(employee => (
                    <div key={employee.id} className="grid grid-cols-4 gap-4 p-4 border-b hover:bg-gray-50 transition-colors duration-150">
